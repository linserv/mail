...
[fetchmail_incoming_test](fetchmail_incoming_test/) | 18.0.1.1.0 |  | Simulate an incoming email from the Incoming Mail Server form
...
[mail_activity_reminder](mail_activity_reminder/) | 18.0.1.0.1 |  | Reminder notifications about planned activities
...
[mail_composer_cc_bcc](mail_composer_cc_bcc/) | 18.0.1.0.3 | <a href='https://github.com/trisdoan'><img src='https://github.com/trisdoan.png' width='32' height='32' style='border-radius:50%;' alt='trisdoan'/></a> | This module enables sending mail to CC and BCC partners in mail composer form.
[mail_composer_cc_bcc_mail_tracking](mail_composer_cc_bcc_mail_tracking/) | 18.0.1.0.0 |  | Show Cc/Bcc recipients below the To line in the chatter.
